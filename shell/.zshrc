...
plugins=(git z sudo history zsh-autosuggestions zsh-syntax-highlighting)
...
alias aider-smart='aider --model openai/qwen2.5-coder-32b-instruct --edit-format diff'
alias aider-fast='aider --model openai/deepseek-coder-v2-lite-instruct --edit-format diff'
